...
import type { CustomSuperTokenMock, CustomSuperTokenMockInterface } from "../../../../contracts/mocks/CustomSuperTokenMock.sol/CustomSuperTokenMock";
export declare class CustomSuperTokenMock__factory {
    ...
    static createInterface(): CustomSuperTokenMockInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): CustomSuperTokenMock;
}
//# sourceMappingURL=CustomSuperTokenMock__factory.d.ts.map