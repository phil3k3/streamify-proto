...
import type { ISETH, ISETHInterface } from "../../../../../contracts/interfaces/tokens/ISETH.sol/ISETH";
export declare class ISETH__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ISETH;
}
//# sourceMappingURL=ISETH__factory.d.ts.map