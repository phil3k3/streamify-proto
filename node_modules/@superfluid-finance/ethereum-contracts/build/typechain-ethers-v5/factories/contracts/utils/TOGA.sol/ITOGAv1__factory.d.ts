...
import type { ITOGAv1, ITOGAv1Interface } from "../../../../contracts/utils/TOGA.sol/ITOGAv1";
export declare class ITOGAv1__factory {
    ...
    static createInterface(): ITOGAv1Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): ITOGAv1;
}
//# sourceMappingURL=ITOGAv1__factory.d.ts.map