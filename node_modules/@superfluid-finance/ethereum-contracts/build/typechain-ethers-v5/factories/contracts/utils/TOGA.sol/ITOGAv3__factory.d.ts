...
import type { ITOGAv3, ITOGAv3Interface } from "../../../../contracts/utils/TOGA.sol/ITOGAv3";
export declare class ITOGAv3__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): ITOGAv3;
}
//# sourceMappingURL=ITOGAv3__factory.d.ts.map