...
export declare class InstantDistributionAgreementV1__factory extends ContractFactory {
    ...
    static readonly abi: readonly [{
        ...
        readonly inputs: readonly [];
        readonly name: "MAX_NUM_SUBSCRIPTIONS";
        ...
        readonly inputs: readonly [];
        readonly name: "SLOTS_BITMAP_LIBRARY_ADDRESS";
        readonly outputs: readonly [{
            readonly internalType: "address";
            readonly name: "";
            readonly type: "address";
    ...
    static createInterface(): InstantDistributionAgreementV1Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): InstantDistributionAgreementV1;
}
export interface InstantDistributionAgreementV1LibraryAddresses {
    ["contracts/libs/SlotsBitmapLibrary.sol:SlotsBitmapLibrary"]: string;
}
export {};
//# sourceMappingURL=InstantDistributionAgreementV1__factory.d.ts.map