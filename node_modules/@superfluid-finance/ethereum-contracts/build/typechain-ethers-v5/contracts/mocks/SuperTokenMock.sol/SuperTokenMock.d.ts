...
export interface SuperTokenMockInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "setupDefaultOperators", values: [string[]]): string;
...
export interface SuperTokenMock extends BaseContract {
    ...
    functions: {
        ...
        setupDefaultOperators(operators: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        setupDefaultOperators(operators: string[], overrides?: CallOverrides): Promise<void>;
        symbol(overrides?: CallOverrides): Promise<string>;
