...
export interface ConstantInflowNFTMockInterface extends utils.Interface {
    functions: {
        ...
        "mockFlowNFTDataByTokenId(uint256)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "CONSTANT_FLOW_AGREEMENT_V1" | "CONSTANT_OUTFLOW_NFT" | "DEFAULT_BASE_URI" | "HOST" | "approve" | "balanceOf" | "baseURI" | "burn" | "castrate" | "flowDataByTokenId" | "getApproved" | "getCodeAddress" | "getTokenId" | "initialize" | "isApprovedForAll" | "mint" | "mockBurn" | "mockFlowNFTDataByTokenId" | "mockGetApproved" | "mockMint" | "mockOwnerOf" | "name" | "ownerOf" | "proxiableUUID" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "triggerMetadataUpdate" | "updateCode"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "mockFlowNFTDataByTokenId", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mockGetApproved", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mockMint", values: [string, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "mockFlowNFTDataByTokenId", data: BytesLike): Result;
...
export interface ConstantInflowNFTMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ConstantInflowNFTMockInterface;
    ...
    functions: {
        ...
        mockFlowNFTDataByTokenId(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<[
            IFlowNFTBase.FlowNFTDataStructOutput
        ] & {
            flowData: IFlowNFTBase.FlowNFTDataStructOutput;
        }>;
        mockGetApproved(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        mockMint(_to: string, _newTokenId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    mockFlowNFTDataByTokenId(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<IFlowNFTBase.FlowNFTDataStructOutput>;
    mockGetApproved(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
    mockMint(_to: string, _newTokenId: BigNumberish, overrides?: Overrides & {
        from?: string;
    }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        mockFlowNFTDataByTokenId(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<IFlowNFTBase.FlowNFTDataStructOutput>;
        mockGetApproved(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        mockMint(_to: string, _newTokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        mockOwnerOf(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        name(overrides?: CallOverrides): Promise<string>;
        ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        proxiableUUID(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        mockFlowNFTDataByTokenId(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        mockFlowNFTDataByTokenId(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=ConstantInflowNFTMock.d.ts.map