...
export interface ConstantOutflowNFTMockInterface extends utils.Interface {
    functions: {
        "CONSTANT_FLOW_AGREEMENT_V1()": FunctionFragment;
        "CONSTANT_INFLOW_NFT()": FunctionFragment;
        "DEFAULT_BASE_URI()": FunctionFragment;
        ...
        "mockBurn(uint256)": FunctionFragment;
        "mockGetApproved(uint256)": FunctionFragment;
        "mockMint(address,address,address,uint256)": FunctionFragment;
        "mockOwnerOf(uint256)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "CONSTANT_FLOW_AGREEMENT_V1" | "CONSTANT_INFLOW_NFT" | "DEFAULT_BASE_URI" | "HOST" | "approve" | "balanceOf" | "baseURI" | "castrate" | "flowDataByTokenId" | "getApproved" | "getCodeAddress" | "getTokenId" | "initialize" | "isApprovedForAll" | "mockBurn" | "mockGetApproved" | "mockMint" | "mockOwnerOf" | "name" | "onCreate" | "onDelete" | "onUpdate" | "ownerOf" | "proxiableUUID" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "triggerMetadataUpdate" | "updateCode"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "DEFAULT_BASE_URI", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "mockBurn", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mockGetApproved", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "mockMint", values: [string, string, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "mockOwnerOf", values: [BigNumberish]): string;
    encodeFunctionData(functionFragment: "name", values?: undefined): string;
    encodeFunctionData(functionFragment: "onCreate", values: [string, string, string]): string;
    encodeFunctionData(functionFragment: "onDelete", values: [string, string, string]): string;
    encodeFunctionData(functionFragment: "onUpdate", values: [string, string, string]): string;
    ...
    decodeFunctionResult(functionFragment: "DEFAULT_BASE_URI", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "mockGetApproved", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mockMint", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "mockOwnerOf", data: BytesLike): Result;
...
export interface ConstantOutflowNFTMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ConstantOutflowNFTMockInterface;
    ...
    functions: {
        ...
        DEFAULT_BASE_URI(overrides?: CallOverrides): Promise<[string]>;
        ...
        getTokenId(superToken: string, sender: string, receiver: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            tokenId: BigNumber;
        }>;
        ...
        mockBurn(_tokenId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        mockGetApproved(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        mockMint(_superToken: string, _to: string, _flowReceiver: string, _newTokenId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        mockOwnerOf(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
        name(overrides?: CallOverrides): Promise<[string]>;
        onCreate(superToken: string, flowSender: string, flowReceiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        onDelete(superToken: string, flowSender: string, flowReceiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        onUpdate(superToken: string, flowSender: string, flowReceiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        isApprovedForAll(owner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        mockBurn(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        mockGetApproved(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        mockMint(_superToken: string, _to: string, _flowReceiver: string, _newTokenId: BigNumberish, overrides?: CallOverrides): Promise<void>;
        mockOwnerOf(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        name(overrides?: CallOverrides): Promise<string>;
        onCreate(superToken: string, flowSender: string, flowReceiver: string, overrides?: CallOverrides): Promise<void>;
        onDelete(superToken: string, flowSender: string, flowReceiver: string, overrides?: CallOverrides): Promise<void>;
        onUpdate(superToken: string, flowSender: string, flowReceiver: string, overrides?: CallOverrides): Promise<void>;
        ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
        proxiableUUID(overrides?: CallOverrides): Promise<string>;
    ...
    estimateGas: {
        ...
        DEFAULT_BASE_URI(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        mockGetApproved(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        mockMint(_superToken: string, _to: string, _flowReceiver: string, _newTokenId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        mockOwnerOf(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        DEFAULT_BASE_URI(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getTokenId(superToken: string, sender: string, receiver: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        initialize(nftName: string, nftSymbol: string, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        ...
        mockGetApproved(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        mockMint(_superToken: string, _to: string, _flowReceiver: string, _newTokenId: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        mockOwnerOf(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=ConstantOutflowNFTMock.d.ts.map