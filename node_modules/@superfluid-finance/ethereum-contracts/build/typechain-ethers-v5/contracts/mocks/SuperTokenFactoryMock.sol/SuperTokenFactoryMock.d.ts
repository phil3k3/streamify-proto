...
export interface SuperTokenFactoryMockInterface extends utils.Interface {
    functions: {
...
export interface SuperTokenFactoryMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SuperTokenFactoryMockInterface;
...
//# sourceMappingURL=SuperTokenFactoryMock.d.ts.map