...
export interface SuperTokenFactoryStorageLayoutTesterInterface extends utils.Interface {
    functions: {
...
export interface SuperTokenFactoryStorageLayoutTester extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SuperTokenFactoryStorageLayoutTesterInterface;
...
//# sourceMappingURL=SuperTokenFactoryStorageLayoutTester.d.ts.map