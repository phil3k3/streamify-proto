...
export interface IPureSuperTokenInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "CONSTANT_INFLOW_NFT" | "CONSTANT_OUTFLOW_NFT" | "allowance" | "approve" | "authorizeOperator" | "balanceOf" | "burn" | "createAgreement" | "decimals" | "decreaseAllowance" | "defaultOperators" | "downgrade" | "downgradeTo" | "getAccountActiveAgreements" | "getAgreementData" | "getAgreementStateSlot" | "getHost" | "getUnderlyingToken" | "granularity" | "increaseAllowance" | "initialize(address,uint8,string,string)" | "initialize(string,string,uint256)" | "isAccountCritical" | "isAccountCriticalNow" | "isAccountSolvent" | "isAccountSolventNow" | "isOperatorFor" | "makeLiquidationPayoutsV2" | "name" | "operationApprove" | "operationDecreaseAllowance" | "operationDowngrade" | "operationIncreaseAllowance" | "operationSend" | "operationTransferFrom" | "operationUpgrade" | "operatorBurn" | "operatorSend" | "realtimeBalanceOf" | "realtimeBalanceOfNow" | "revokeOperator" | "selfApproveFor" | "selfBurn" | "selfMint" | "selfTransferFrom" | "send" | "settleBalance" | "symbol" | "terminateAgreement" | "totalSupply" | "transfer" | "transferAll" | "transferFrom" | "updateAgreementData" | "updateAgreementStateSlot" | "upgrade" | "upgradeTo"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "downgradeTo", values: [string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "initialize(address,uint8,string,string)", values: [string, BigNumberish, string, string]): string;
    encodeFunctionData(functionFragment: "initialize(string,string,uint256)", values: [string, string, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "operationDecreaseAllowance", values: [string, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "operationDowngrade", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "operationIncreaseAllowance", values: [string, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "operationSend", values: [string, string, BigNumberish, BytesLike]): string;
    ...
    decodeFunctionResult(functionFragment: "initialize(address,uint8,string,string)", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "initialize(string,string,uint256)", data: BytesLike): Result;
...
export interface IPureSuperToken extends BaseContract {
    ...
    functions: {
        ...
        burn(amount: BigNumberish, userData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        downgradeTo(to: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        "initialize(address,uint8,string,string)"(underlyingToken: string, underlyingDecimals: BigNumberish, n: string, s: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "initialize(string,string,uint256)"(name: string, symbol: string, initialSupply: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        operationDecreaseAllowance(account: string, spender: string, subtractedValue: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        operationDowngrade(account: string, amount: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        operationIncreaseAllowance(account: string, spender: string, addedValue: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        operationSend(spender: string, recipient: string, amount: BigNumberish, userData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        operatorBurn(account: string, amount: BigNumberish, userData: BytesLike, operatorData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        operatorSend(sender: string, recipient: string, amount: BigNumberish, userData: BytesLike, operatorData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        send(recipient: string, amount: BigNumberish, userData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        upgradeTo(to: string, amount: BigNumberish, userData: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    };
    CONSTANT_INFLOW_NFT(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        balanceOf(account: string, overrides?: CallOverrides): Promise<BigNumber>;
        burn(amount: BigNumberish, userData: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        downgradeTo(to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        getAccountActiveAgreements(account: string, overrides?: CallOverrides): Promise<string[]>;
        getAgreementData(agreementClass: string, id: BytesLike, dataLength: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
        getAgreementStateSlot(agreementClass: string, account: string, slotId: BigNumberish, dataLength: BigNumberish, overrides?: CallOverrides): Promise<string[]>;
        getHost(overrides?: CallOverrides): Promise<string>;
        ...
        "initialize(address,uint8,string,string)"(underlyingToken: string, underlyingDecimals: BigNumberish, n: string, s: string, overrides?: CallOverrides): Promise<void>;
        "initialize(string,string,uint256)"(name: string, symbol: string, initialSupply: BigNumberish, overrides?: CallOverrides): Promise<void>;
        isAccountCritical(account: string, timestamp: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isAccountCriticalNow(account: string, overrides?: CallOverrides): Promise<boolean>;
        isAccountSolvent(account: string, timestamp: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isAccountSolventNow(account: string, overrides?: CallOverrides): Promise<boolean>;
        ...
        operationDecreaseAllowance(account: string, spender: string, subtractedValue: BigNumberish, overrides?: CallOverrides): Promise<void>;
        operationDowngrade(account: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        operationIncreaseAllowance(account: string, spender: string, addedValue: BigNumberish, overrides?: CallOverrides): Promise<void>;
        operationSend(spender: string, recipient: string, amount: BigNumberish, userData: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        operatorBurn(account: string, amount: BigNumberish, userData: BytesLike, operatorData: BytesLike, overrides?: CallOverrides): Promise<void>;
        operatorSend(sender: string, recipient: string, amount: BigNumberish, userData: BytesLike, operatorData: BytesLike, overrides?: CallOverrides): Promise<void>;
        realtimeBalanceOf(account: string, timestamp: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber
        ...
        send(recipient: string, amount: BigNumberish, userData: BytesLike, overrides?: CallOverrides): Promise<void>;
        ...
        upgradeTo(to: string, amount: BigNumberish, userData: BytesLike, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        ...
        "ConstantInflowNFTCreated(address)"(constantInflowNFT?: string | null): ConstantInflowNFTCreatedEventFilter;
        ConstantInflowNFTCreated(constantInflowNFT?: string | null): ConstantInflowNFTCreatedEventFilter;
        "ConstantOutflowNFTCreated(address)"(constantOutflowNFT?: string | null): ConstantOutflowNFTCreatedEventFilter;
        ConstantOutflowNFTCreated(constantOutflowNFT?: string | null): ConstantOutflowNFTCreatedEventFilter;
...
//# sourceMappingURL=IPureSuperToken.d.ts.map