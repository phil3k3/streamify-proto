...
export interface IPureSuperTokenCustom extends BaseContract {
    ...
    functions: {
        initialize(name: string, symbol: string, initialSupply: BigNumberish, overrides?: Overrides & {
            from?: string;
    ...
    callStatic: {
        initialize(name: string, symbol: string, initialSupply: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {};
    estimateGas: {
        initialize(name: string, symbol: string, initialSupply: BigNumberish, overrides?: Overrides & {
