...
export interface ISuperfluidGovernanceInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "batchUpdateSuperTokenLogic(address,address[])" | "batchUpdateSuperTokenLogic(address,address[],address[])" | "clearConfig" | "getConfigAsAddress" | "getConfigAsUint256" | "registerAgreementClass" | "replaceGovernance" | "setConfig(address,address,bytes32,address)" | "setConfig(address,address,bytes32,uint256)" | "updateContracts"): FunctionFragment;
