...
export interface ISuperfluid extends BaseContract {
    ...
    estimateGas: {
        ...
        getAppCallbackLevel(app: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getAppCallbackLevel(app: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
