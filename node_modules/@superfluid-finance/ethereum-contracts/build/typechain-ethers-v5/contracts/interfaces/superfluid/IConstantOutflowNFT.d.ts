...
export interface IConstantOutflowNFTInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "approve" | "balanceOf" | "flowDataByTokenId" | "getApproved" | "getTokenId" | "initialize" | "isApprovedForAll" | "name" | "onCreate" | "onDelete" | "onUpdate" | "ownerOf" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "triggerMetadataUpdate"): FunctionFragment;
...
export interface IConstantOutflowNFT extends BaseContract {
    ...
    functions: {
        ...
        onCreate(token: string, flowSender: string, flowReceiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        onDelete(token: string, flowSender: string, flowReceiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        onUpdate(token: string, flowSender: string, flowReceiver: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        isApprovedForAll(owner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        name(overrides?: CallOverrides): Promise<string>;
        onCreate(token: string, flowSender: string, flowReceiver: string, overrides?: CallOverrides): Promise<void>;
        onDelete(token: string, flowSender: string, flowReceiver: string, overrides?: CallOverrides): Promise<void>;
        onUpdate(token: string, flowSender: string, flowReceiver: string, overrides?: CallOverrides): Promise<void>;
        ownerOf(tokenId: BigNumberish, overrides?: CallOverrides): Promise<string>;
...
//# sourceMappingURL=IConstantOutflowNFT.d.ts.map