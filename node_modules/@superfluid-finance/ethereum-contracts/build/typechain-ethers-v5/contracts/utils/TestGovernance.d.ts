...
export interface TestGovernanceInterface extends utils.Interface {
    functions: {
        "authorizeAppFactory(address,address)": FunctionFragment;
        "batchUpdateSuperTokenLogic(address,address[])": FunctionFragment;
        "batchUpdateSuperTokenLogic(address,address[],address[])": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "authorizeAppFactory" | "batchUpdateSuperTokenLogic(address,address[])" | "batchUpdateSuperTokenLogic(address,address[],address[])" | "batchUpdateSuperTokenMinimumDeposit" | "clearAppRegistrationKey" | "clearConfig" | "clearPPPConfig" | "clearRewardAddress" | "clearSuperTokenMinimumDeposit" | "disableTrustedForwarder" | "enableTrustedForwarder" | "getConfigAsAddress" | "getConfigAsUint256" | "getPPPConfig" | "getRewardAddress" | "getSuperTokenMinimumDeposit" | "initialize" | "isAuthorizedAppFactory" | "isTrustedForwarder" | "owner" | "registerAgreementClass" | "renounceOwnership" | "replaceGovernance" | "setAppRegistrationKey" | "setConfig(address,address,bytes32,address)" | "setConfig(address,address,bytes32,uint256)" | "setPPPConfig" | "setRewardAddress" | "setSuperTokenMinimumDeposit" | "transferOwnership" | "unauthorizeAppFactory" | "updateContracts" | "verifyAppRegistrationKey"): FunctionFragment;
    encodeFunctionData(functionFragment: "authorizeAppFactory", values: [string, string]): string;
    encodeFunctionData(functionFragment: "batchUpdateSuperTokenLogic(address,address[])", values: [string, string[]]): string;
    encodeFunctionData(functionFragment: "batchUpdateSuperTokenLogic(address,address[],address[])", values: [string, string[], string[]]): string;
    encodeFunctionData(functionFragment: "batchUpdateSuperTokenMinimumDeposit", values: [string, string[], BigNumberish[]]): string;
    encodeFunctionData(functionFragment: "clearAppRegistrationKey", values: [string, string, string]): string;
    ...
    encodeFunctionData(functionFragment: "initialize", values: [string, string, BigNumberish, BigNumberish, string[]]): string;
    ...
    encodeFunctionData(functionFragment: "setAppRegistrationKey", values: [string, string, string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "setConfig(address,address,bytes32,address)", values: [string, string, BytesLike, string]): string;
    encodeFunctionData(functionFragment: "setConfig(address,address,bytes32,uint256)", values: [string, string, BytesLike, BigNumberish]): string;
    ...
    encodeFunctionData(functionFragment: "verifyAppRegistrationKey", values: [string, string, string]): string;
    decodeFunctionResult(functionFragment: "authorizeAppFactory", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "batchUpdateSuperTokenLogic(address,address[])", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "batchUpdateSuperTokenLogic(address,address[],address[])", data: BytesLike): Result;
...
export interface TestGovernance extends BaseContract {
    ...
    functions: {
        ...
        "batchUpdateSuperTokenLogic(address,address[])"(host: string, tokens: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        "batchUpdateSuperTokenLogic(address,address[],address[])"(host: string, tokens: string[], tokenLogics: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        batchUpdateSuperTokenMinimumDeposit(host: string, tokens: string[], minimumDeposits: BigNumberish[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        clearAppRegistrationKey(host: string, deployer: string, registrationKey: string, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        initialize(host: string, rewardAddress: string, liquidationPeriod: BigNumberish, patricianPeriod: BigNumberish, trustedForwarders: string[], overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        setAppRegistrationKey(host: string, deployer: string, registrationKey: string, expirationTs: BigNumberish, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        verifyAppRegistrationKey(host: string, deployer: string, registrationKey: string, overrides?: CallOverrides): Promise<[
            boolean,
            BigNumber
        ] & {
            validNow: boolean;
    ...
    callStatic: {
        ...
        "batchUpdateSuperTokenLogic(address,address[])"(host: string, tokens: string[], overrides?: CallOverrides): Promise<void>;
        "batchUpdateSuperTokenLogic(address,address[],address[])"(host: string, tokens: string[], tokenLogics: string[], overrides?: CallOverrides): Promise<void>;
        ...
        clearAppRegistrationKey(host: string, deployer: string, registrationKey: string, overrides?: CallOverrides): Promise<void>;
        ...
        getRewardAddress(host: string, superToken: string, overrides?: CallOverrides): Promise<string>;
        getSuperTokenMinimumDeposit(host: string, superToken: string, overrides?: CallOverrides): Promise<BigNumber>;
        initialize(host: string, rewardAddress: string, liquidationPeriod: BigNumberish, patricianPeriod: BigNumberish, trustedForwarders: string[], overrides?: CallOverrides): Promise<void>;
        isAuthorizedAppFactory(host: string, factory: string, overrides?: CallOverrides): Promise<boolean>;
        isTrustedForwarder(host: string, superToken: string, forwarder: string, overrides?: CallOverrides): Promise<boolean>;
        owner(overrides?: CallOverrides): Promise<string>;
        ...
        setAppRegistrationKey(host: string, deployer: string, registrationKey: string, expirationTs: BigNumberish, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        "AppFactoryAuthorizationChanged(address,address,bool)"(host?: string | null, factory?: string | null, authorized?: null): AppFactoryAuthorizationChangedEventFilter;
        AppFactoryAuthorizationChanged(host?: string | null, factory?: string | null, authorized?: null): AppFactoryAuthorizationChangedEventFilter;
        "AppRegistrationKeyChanged(address,address,string,uint256)"(host?: string | null, deployer?: string | null, appRegistrationKey?: null, expirationTs?: null): AppRegistrationKeyChangedEventFilter;
        AppRegistrationKeyChanged(host?: string | null, deployer?: string | null, appRegistrationKey?: null, expirationTs?: null): AppRegistrationKeyChangedEventFilter;
    ...
    estimateGas: {
        ...
        verifyAppRegistrationKey(host: string, deployer: string, registrationKey: string, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        authorizeAppFactory(host: string, factory: string, overrides?: Overrides & {
            from?: string;
        ...
        verifyAppRegistrationKey(host: string, deployer: string, registrationKey: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=TestGovernance.d.ts.map