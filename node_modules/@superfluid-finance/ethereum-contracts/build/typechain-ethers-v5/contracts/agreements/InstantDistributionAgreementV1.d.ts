...
export interface InstantDistributionAgreementV1Interface extends utils.Interface {
    functions: {
        "MAX_NUM_SUBSCRIPTIONS()": FunctionFragment;
        "SLOTS_BITMAP_LIBRARY_ADDRESS()": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "MAX_NUM_SUBSCRIPTIONS" | "SLOTS_BITMAP_LIBRARY_ADDRESS" | "agreementType" | "approveSubscription" | "calculateDistribution" | "castrate" | "claim" | "createIndex" | "deleteSubscription" | "distribute" | "getCodeAddress" | "getIndex" | "getSubscription" | "getSubscriptionByID" | "listSubscriptions" | "proxiableUUID" | "realtimeBalanceOf" | "revokeSubscription" | "updateCode" | "updateIndex" | "updateSubscription"): FunctionFragment;
    encodeFunctionData(functionFragment: "MAX_NUM_SUBSCRIPTIONS", values?: undefined): string;
    encodeFunctionData(functionFragment: "SLOTS_BITMAP_LIBRARY_ADDRESS", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "MAX_NUM_SUBSCRIPTIONS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "SLOTS_BITMAP_LIBRARY_ADDRESS", data: BytesLike): Result;
...
export interface InstantDistributionAgreementV1 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: InstantDistributionAgreementV1Interface;
    ...
    functions: {
        MAX_NUM_SUBSCRIPTIONS(overrides?: CallOverrides): Promise<[number]>;
        SLOTS_BITMAP_LIBRARY_ADDRESS(overrides?: CallOverrides): Promise<[string]>;
        ...
        realtimeBalanceOf(token: string, account: string, arg2: BigNumberish, overrides?: CallOverrides): Promise<[
            BigNumber,
            BigNumber,
            BigNumber
        ] & {
    ...
    estimateGas: {
        MAX_NUM_SUBSCRIPTIONS(overrides?: CallOverrides): Promise<BigNumber>;
        SLOTS_BITMAP_LIBRARY_ADDRESS(overrides?: CallOverrides): Promise<BigNumber>;
        ...
        realtimeBalanceOf(token: string, account: string, arg2: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>;
        revokeSubscription(token: string, publisher: string, indexId: BigNumberish, ctx: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<BigNumber>;
        updateCode(newAddress: string, overrides?: Overrides & {
    ...
    populateTransaction: {
        MAX_NUM_SUBSCRIPTIONS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        SLOTS_BITMAP_LIBRARY_ADDRESS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        realtimeBalanceOf(token: string, account: string, arg2: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        revokeSubscription(token: string, publisher: string, indexId: BigNumberish, ctx: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        updateCode(newAddress: string, overrides?: Overrides & {
